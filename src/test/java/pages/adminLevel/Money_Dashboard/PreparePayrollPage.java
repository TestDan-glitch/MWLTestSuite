package pages.adminLevel.Money_Dashboard;
...
public class PreparePayrollPage extends UIInteractionSteps{
    @Managed
    WebDriver driver;

    @FindBy(how = How.LINK_TEXT, using = "Create Payment")
    ...
    public void ClickCreatePaymentBtn() throws InterruptedException {
